...
class collection_postWidget extends StatefulWidget {
  final postData;

  collection_postWidget(this.postData);
  @override
  _collection_postWidgetState createState() => _collection_postWidgetState();
}

class _collection_postWidgetState extends State<collection_postWidget> {
