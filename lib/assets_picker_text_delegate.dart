...
class AssetsPickerTextDelegate {
  ...
  /// HEIC failed string.
  /// HEIC 類型資源加載失敗的字段
  String get heicNotSupported => '尚未支持HEIC類型資源';
  ...
  /// 未支持的資源類型的字段
  String get unSupportedAssetType => '尚未支持的資源類型';

  /// "Unable to access all assets in album".
  String get unableToAccessAll => '無法訪問所有資源';

  String get viewingLimitedAssetsTip => '應用只能訪問部分資源和相冊';

  String get changeAccessibleLimitedAssets => '設置可訪問的資源';

  String get accessAllTip => '你已設置應用只能訪問設備部分資源，'
      '建議允許訪問「所有資源」';

  String get goToSystemSettings => '前往系統設置';

  /// "Continue accessing some assets".
  String get accessLimitedAssets => '繼續訪問部分資源';

  String get accessiblePathName => '可訪問的資源';
